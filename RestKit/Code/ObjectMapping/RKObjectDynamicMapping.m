...
- (RKObjectMapping*)objectMappingForDictionary:(NSDictionary*)data {
    NSString* desc = [NSString stringWithFormat:@"Dynamic object mapping can only be performed on NSDictionary mappables, got %@", NSStringFromClass([data class])];
    
    NSAssert([data isKindOfClass:[NSDictionary class]], desc);
